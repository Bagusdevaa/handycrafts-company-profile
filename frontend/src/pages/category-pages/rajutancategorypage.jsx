...
const RajutanCategoryPage = () => {
  ...
  const categoryInfo = {
    title: 'Rajutan & Tenun',
    description: 'Ahli dalam produksi tekstil buatan tangan dengan motif tradisional Indonesia. Setiap produk dibuat dengan teliti oleh pengrajin berpengalaman untuk menghasilkan kualitas terbaik.',
    icon: '🧶',
    color: 'purple',
    ...
    expertise: [
      ...
      'Rajutan Premium Wool',
      'Tas & Aksesoris',
      'Tekstil Custom Pattern'
    ],
    process: [
      'Design Pattern',
      'Pemilihan Benang',
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        ...
        const categoryProjects = response.filter(product => product.category === 'rajutan');
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative mt-16">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-purple-800 opacity-85"></div>
        </div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {categoryInfo.expertise.map((skill, index) => (
              <div 
                key={index}
                className="bg-purple-100 p-6 rounded-xl text-center hover:shadow-lg transition-shadow"
                data-aos="fade-up"
                data-aos-delay={index * 100}
              >
                <div className="text-2xl text-purple-800 font-bold mb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            {categoryInfo.process.map((step, index) => (
              <div key={index} className="text-center relative" data-aos="fade-up" data-aos-delay={index * 100}>
                <div className="w-16 h-16 bg-gradient-to-r from-purple-600 to-purple-800 rounded-full flex items-center justify-center text-white font-bold text-xl mx-auto mb-4">
                  {index + 1}
                </div>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-4">
            Our Textile Projects
          </h2>
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            Berikut adalah beberapa project rajutan & tenun yang telah kami kerjakan dengan hasil yang memuaskan
          </p>
          ...
          {projects.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-gray-600">
                Project rajutan & tenun akan segera ditampilkan di sini
              </p>
            </div>
          ) : (
        ...
        {/* Contact CTA Section */}
        <div className="bg-gradient-to-r from-purple-600 to-purple-800 rounded-2xl text-white p-12 text-center">
          <h2 className="text-3xl font-bold mb-4">
            Tertarik dengan Rajutan & Tenun?
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Hubungi kami untuk konsultasi gratis dan dapatkan penawaran terbaik untuk project rajutan & tenun Anda
          </p>
...
export default RajutanCategoryPage;
