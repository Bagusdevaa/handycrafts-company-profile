...
const PerawatanCategoryPage = () => {
  ...
  const categoryInfo = {
    ...
    description: 'Produksi produk perawatan kulit dan tubuh dari bahan-bahan alami pilihan. Kami berkomitmen untuk menghadirkan produk yang aman, berkualitas, dan ramah lingkungan.',
    icon: '🌿',
    color: 'blue',
    heroImage: 'https://images.unsplash.com/photo-1556228453-efd6c1ff04f6?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    expertise: [
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        ...
        const categoryProjects = response.filter(product => product.category === 'perawatan');
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative mt-16">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-blue-800 opacity-85"></div>
        </div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {categoryInfo.expertise.map((skill, index) => (
              <div 
                key={index}
                className="bg-blue-100 p-6 rounded-xl text-center hover:shadow-lg transition-shadow"
                data-aos="fade-up"
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            {categoryInfo.process.map((step, index) => (
              <div key={index} className="text-center relative">
                <div className="w-16 h-16 bg-gradient-to-r from-blue-600 to-blue-800 rounded-full flex items-center justify-center text-white font-bold text-xl mx-auto mb-4">
                  {index + 1}
                </div>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-4">
            Our Natural Care Projects
          </h2>
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            Berikut adalah beberapa project perawatan alami yang telah kami kerjakan dengan hasil yang memuaskan
          </p>
          ...
          {projects.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-gray-600">
                Project perawatan alami akan segera ditampilkan di sini
              </p>
            </div>
          ) : (
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl text-white p-12 text-center">
          <h2 className="text-3xl font-bold mb-4">
            Tertarik dengan Perawatan Alami?
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Hubungi kami untuk konsultasi gratis dan dapatkan penawaran terbaik untuk project perawatan alami Anda
          </p>
...
export default PerawatanCategoryPage;
